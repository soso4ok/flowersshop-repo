...
public class AuthController {
    ...
    public ResponseEntity<java.util.Map<String, String>> register(@RequestBody UserDTO request) {
        try {
            ...
            return new ResponseEntity<>(java.util.Map.of("error", "Unexpected error during registration"),
    ...
    public ResponseEntity<?> confirmEmail(@RequestParam("token") String token) {
        try {
            AuthenticationResponse response = authenticationService.confirmToken(token);
